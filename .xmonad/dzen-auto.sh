...
sleep 1
stalonetray --grow-gravity NE --window-strut bottom -bg "#000000" --kludges=fix_window_pos,use_icons_hints,force_icons_size -i 19 --icon-gravity NE --geometry 7x1-0-0 --no-shrink&
