...
myManageHook =
    ...
    where
        ...
        doc = ["skypeforlinux", "calibre", "FBReader", "Evince", "Blender", "Gimp", "Gimp-2.8", "Gimp-2.9", "okular", "Okular", "Zathura", "libreoffice", "libreoffice-writer", "libreoffice-calc", "libreoffice-impress", "libreoffice-startcenter", "VCLSalFrame.DocumentWindow", "VCLSalFrame"]
        ...
        im = ["Thunderbird", "Pidgin", "Corebird", "Slack", "Telegram", "TelegramDesktop"]
