...
myManageHook = (scratchpadManageHook (W.RationalRect 0 0 1 0.4)) <+>
    ...
    where
        ...
        code = ["Pycrust-3.0", "jetbrains-idea", "Qvim", "Emacs", "Gvim", "jetbrains-idea-ce", "Codelite", "NetBeans IDE 8.0", "Subl3", "Leksah"]
        ...
        media = ["nuvolaplayer3", "mpv", "nuvolaplayer3-deezer", "google-music-electron", "Tomahawk", "nuvolaplayer", "Vlc", "MPlayer", "Umplayer", "Smplayer", "Cheese", "Minitube"]
